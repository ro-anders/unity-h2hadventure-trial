...
namespace GameEngine
{
    public class Map
    {
        ...
        public Map(int numPlayers, int gameMapLayout)
        {
            ...
            ComputeDistances(new Portcullis[0]);
        }
        ...
        void defaultRooms()
        {
            ...
            addRoom(NUMBER_ROOM, new ROOM(roomGfxNumberRoom, ROOM.FLAG_NONE, _COLOR.PURPLE,                       // 0x00
                                                NUMBER_ROOM, NUMBER_ROOM, NUMBER_ROOM, NUMBER_ROOM, "Number Room", ROOM.RandomVisibility.HIDDEN));
            addRoom(MAIN_HALL_LEFT, new ROOM(roomGfxBelowYellowCastle, ROOM.FLAG_LEFTTHINWALL, _COLOR.OLIVEGREEN, // 0x01
                                             BLUE_MAZE_1, MAIN_HALL_CENTER, BLACK_CASTLE, MAIN_HALL_RIGHT, "Main Hall Left"));
            addRoom(MAIN_HALL_CENTER, new ROOM(roomGfxBelowYellowCastle, ROOM.FLAG_NONE, _COLOR.LIMEGREEN,        // 0x02
                                               GOLD_CASTLE, MAIN_HALL_RIGHT, BLUE_MAZE_2, MAIN_HALL_LEFT, "Main Hall Center"));
            addRoom(MAIN_HALL_RIGHT, new ROOM(roomGfxSideCorridor, ROOM.FLAG_RIGHTTHINWALL, _COLOR.TAN,          // 0x03
                                            COPPER_CASTLE, MAIN_HALL_LEFT, SOUTHEAST_ROOM, MAIN_HALL_CENTER, "Main Hall Right"));
            addRoom(BLUE_MAZE_5, new ROOM(roomGfxBlueMazeTop, ROOM.FLAG_NONE, _COLOR.BLUE,                        // 0x04
                                          0x10, 0x05, 0x07, 0x06, "Blue Maze 5"));
            addRoom(BLUE_MAZE_2, new ROOM(roomGfxBlueMaze1, ROOM.FLAG_NONE, _COLOR.BLUE,                          // 0x05
                                          0x1D, 0x06, 0x08, 0x04, "Blue Maze 2"));
            addRoom(BLUE_MAZE_3, new ROOM(roomGfxBlueMazeBottom, ROOM.FLAG_NONE, _COLOR.BLUE,                     // 0x06
                                          0x07, 0x04, 0x03, 0x05, "Blue Maze 3"));
            addRoom(BLUE_MAZE_4, new ROOM(roomGfxBlueMazeCenter, ROOM.FLAG_NONE, _COLOR.BLUE,                     // 0x07
                                          0x04, 0x08, 0x06, 0x08, "Blue Maze 4"));
            addRoom(BLUE_MAZE_1, new ROOM(roomGfxBlueMazeEntry, ROOM.FLAG_NONE, _COLOR.BLUE,                      // 0x08
                                          0x05, 0x07, 0x01, 0x07, "Blue Maze 1"));
            addRoom(WHITE_MAZE_2, new ROOM(roomGfxMazeMiddle, ROOM.FLAG_NONE, _COLOR.LTGRAY,                      // 0x09
                                           WHITE_MAZE_1, WHITE_MAZE_1, WHITE_MAZE_3, WHITE_MAZE_1, "White Maze 2"));
            addRoom(WHITE_MAZE_1, new ROOM(roomGfxMazeEntry, ROOM.FLAG_NONE, _COLOR.LTGRAY,                       // 0x0A
                                           MAIN_HALL_RIGHT, WHITE_MAZE_2, WHITE_MAZE_2, WHITE_MAZE_2, "White Maze 1"));
            addRoom(WHITE_MAZE_3, new ROOM(roomGfxMazeSide, ROOM.FLAG_NONE, _COLOR.LTGRAY,                        // 0x0B
                                           WHITE_MAZE_2, SOUTH_HALL_RIGHT, COPPER_CASTLE, SOUTH_HALL_LEFT, "White Maze 3"));
            addRoom(SOUTH_HALL_RIGHT, new ROOM(roomGfxSideCorridor, ROOM.FLAG_RIGHTTHINWALL, _COLOR.LTCYAN,       // 0x0C
                                               COPPER_CASTLE, SOUTH_HALL_LEFT, SOUTHEAST_ROOM, WHITE_MAZE_3, "South Hall Right"));
            addRoom(SOUTH_HALL_LEFT, new ROOM(roomGfxSideCorridor, ROOM.FLAG_LEFTTHINWALL, _COLOR.DKGREEN,        // 0x0D
                                              0x0F, 0x0B, 0x0E, 0x0C, "South Hall Left"));                         // 0x0E
            addRoom(SOUTHWEST_ROOM, new ROOM(roomGfxTopEntryRoom, ROOM.FLAG_NONE, _COLOR.CYAN,
                                             0x0D, 0x10, 0x0F, 0x10, "Southwest Room"));
            addRoom(WHITE_CASTLE, new ROOM(roomGfxCastle, ROOM.FLAG_NONE, _COLOR.WHITE,                           // 0x0F
                                           0x0E, 0x0F, 0x0D, 0x0F, "White Castle"));
            addRoom(BLACK_CASTLE, new ROOM(roomGfxCastle, ROOM.FLAG_NONE, _COLOR.BLACK,                           // 0x10
                                           0x01, 0x1C, 0x04, 0x1C, "Black Castle"));
            addRoom(GOLD_CASTLE, new ROOM(roomGfxCastle, ROOM.FLAG_NONE, _COLOR.YELLOW,                           // 0x11
                                          0x06, 0x03, 0x02, 0x01, "Gold Castle"));
            addRoom(GOLD_FOYER, new ROOM(roomGfxNumberRoom, ROOM.FLAG_NONE, _COLOR.YELLOW,                        // 0x12
                                         GOLD_FOYER, GOLD_FOYER, GOLD_FOYER, GOLD_FOYER, "Gold Foyer"));
            addRoom(BLACK_MAZE_1, new ROOM(roomGfxBlackMaze1, ROOM.FLAG_NONE, _COLOR.LTGRAY,                      // 0x13
                                           0x15, 0x14, 0x15, 0x16, "Black Maze 1"));
            addRoom(BLACK_MAZE_2, new ROOM(roomGfxBlackMaze2, ROOM.FLAG_MIRROR, _COLOR.LTGRAY,                    // 0x14
                                           0x16, 0x15, 0x16, 0x13, "Black Maze 2"));
            addRoom(BLACK_MAZE_3, new ROOM(roomGfxBlackMaze3, ROOM.FLAG_MIRROR, _COLOR.LTGRAY,                    // 0x15
                                           0x13, 0x16, 0x13, 0x14, "Black Maze 3"));
            addRoom(BLACK_MAZE_ENTRY, new ROOM(roomGfxBlackMazeEntry, ROOM.FLAG_NONE, _COLOR.LTGRAY,              // 0x16
                                               0x14, 0x13, 0x1B, 0x15, "Black Maze Entry"));
            addRoom(RED_MAZE_3, new ROOM(roomGfxRedMaze1, ROOM.FLAG_NONE, _COLOR.RED,                             // 0x17
                                         0x19, 0x18, 0x19, 0x18, "Red Maze 3"));
            addRoom(RED_MAZE_2, new ROOM(roomGfxRedMazeTop, ROOM.FLAG_NONE, _COLOR.RED,                           // 0x18
                                         0x1A, 0x17, 0x1A, 0x17, "Red Maze 2"));
            addRoom(RED_MAZE_4, new ROOM(roomGfxRedMazeBottom, ROOM.FLAG_NONE, _COLOR.RED,                        // 0x19
                                         0x17, 0x1A, 0x17, 0x1A, "Red Maze4 "));
            addRoom(RED_MAZE_1, new ROOM(roomGfxWhiteCastleEntry, ROOM.FLAG_NONE, _COLOR.RED,                     // 0x1A
                                         0x18, 0x19, 0x18, 0x19, "Red Maze 1"));
            addRoom(BLACK_FOYER, new ROOM(roomGfxTwoExitRoom, ROOM.FLAG_NONE, _COLOR.RED,                         // 0x1B
                                BLACK_INNERMOST_ROOM, BLACK_INNERMOST_ROOM, BLACK_INNERMOST_ROOM, BLACK_INNERMOST_ROOM, "Black Foyer"));
            addRoom(BLACK_INNERMOST_ROOM, new ROOM(roomGfxNumberRoom, ROOM.FLAG_NONE, _COLOR.PURPLE,              // 0x1C
                                    SOUTHEAST_ROOM, BLUE_MAZE_4, BLACK_FOYER, BLUE_MAZE_1, "Black Innermost Room"));
            addRoom(SOUTHEAST_ROOM, new ROOM(roomGfxTopEntryRoom, ROOM.FLAG_NONE, _COLOR.RED,                     // 0x1D
                                             MAIN_HALL_RIGHT, MAIN_HALL_LEFT, BLACK_CASTLE, MAIN_HALL_RIGHT, "Southeast Room"));
            addRoom(ROBINETT_ROOM, new ROOM(roomGfxBelowYellowCastle, ROOM.FLAG_NONE, _COLOR.PURPLE,              // 0x1E
                                            CRYSTAL_CASTLE, MAIN_HALL_LEFT, CRYSTAL_CASTLE, MAIN_HALL_RIGHT, "Robinett Room", ROOM.RandomVisibility.HIDDEN));
            addRoom(JADE_CASTLE, new ROOM(roomGfxCastle3, ROOM.FLAG_NONE, _COLOR.JADE,                            // 0x1F
                                          SOUTHEAST_ROOM, BLUE_MAZE_3, BLUE_MAZE_2, BLUE_MAZE_5, "Jade Castle", ROOM.RandomVisibility.HIDDEN));
            addRoom(JADE_FOYER, new ROOM(roomGfxNumberRoom, ROOM.FLAG_NONE, _COLOR.JADE,                          // 0x20
                                         JADE_FOYER, JADE_FOYER, JADE_FOYER, JADE_FOYER, "Jade Foyer", ROOM.RandomVisibility.HIDDEN));
            addRoom(COPPER_CASTLE, new ROOM(roomGfxCastle2, ROOM.FLAG_NONE, _COLOR.COPPER,                        // 0x21
                                            BLUE_MAZE_3, MAIN_HALL_LEFT, MAIN_HALL_RIGHT, GOLD_CASTLE, "Copper Castle"));
            addRoom(COPPER_FOYER, new ROOM(roomGfxNumberRoom, ROOM.FLAG_NONE, _COLOR.COPPER,                      // 0x22
                                           COPPER_FOYER, COPPER_FOYER, COPPER_FOYER, COPPER_FOYER, "Copper Foyer"));
            addRoom(CRYSTAL_CASTLE, new ROOM(roomGfxCastle4, ROOM.FLAG_NONE, _COLOR.CRYSTAL,                        // 0x23
                                             ROBINETT_ROOM, CRYSTAL_CASTLE, ROBINETT_ROOM, CRYSTAL_CASTLE, "Crystal Castle", ROOM.RandomVisibility.HIDDEN));
            addRoom(CRYSTAL_FOYER, new ROOM(roomGfxNumberRoom, ROOM.FLAG_NONE, _COLOR.DARK_CRYSTAL4,                      // 0x24
        ...
        void addCastles(Portcullis[] ports)
        {
